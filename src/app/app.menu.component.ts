...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
	    this.model = [
		    /*{label: 'Empty Page', icon: 'hourglass_empty', routerLink: ['/']},*/
		    {label: 'Home', icon: 'dashboard', routerLink: ['/dashboard']},
		    {
			    label: 'Patient', icon: 'person',
			    items: [
				    {label: 'Biographic Data', icon: 'storage', routerLink: ['/biography']},
				    {label: 'History', icon: 'history', command: (event) => {this.changeTheme('brown')}},
				    {label: 'Travel History', icon: 'local_airport', command: (event) => {this.changeTheme('blue')}},
				    {label: 'Contact', icon: 'contact_phone', command: (event) => {this.changeTheme('blue-grey')}},
				    {label: 'Allergy', icon: 'spa', command: (event) => {this.changeTheme('dark-blue')}},
				    {label: 'Home Medication Info', icon: 'local_hospital', command: (event) => {this.changeTheme('dark-green')}},
				    {label: 'Consent & Authority', icon: 'announcement', command: (event) => {this.changeTheme('green')}},
				    {label: 'Emergency Notes', icon: 'note', command: (event) => {this.changeTheme('purple-cyan')}},
				    {label: 'Belongings', icon: 'brush', command: (event) => {this.changeTheme('purple-amber')}}
			    ]
		    },
		    {
